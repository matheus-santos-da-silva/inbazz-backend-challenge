import { FindTodoService } from "../../../src/application/todos/use-cases";
...
describe("Find Todo Service", () => {
  let service: FindTodoService;
  ...
  beforeEach(async () => {
    ...
    service = module.get<FindTodoService>(FindTodoService);
